...
interface LMSRMarketMakerDataInterface extends ethers.utils.Interface {
  functions: {};
...
export class LMSRMarketMakerData extends BaseContract {
  ...
  interface: LMSRMarketMakerDataInterface;
